...
sleep 20 && cd zuul-server-microservice && nohup mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=9096 &
sleep 20 && cd zuul-server-microservice && nohup mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=9099 &
sleep 20 && cd zuul-server-microservice && nohup mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=9210 &
sleep 20 && cd zuul-server-microservice && nohup mvn spring-boot:run -Dspring-boot.run.arguments=--server.port=9211 &
